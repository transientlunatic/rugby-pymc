    ...
    def _load_list_format(self, data: list, competition: str, season: str) -> None:
        ...
        for i, match in enumerate(data):
            try:
                ...
                self._index_players_from_lineup(match_data.home_lineup)
                self._index_players_from_lineup(match_data.away_lineup)
    ...
    def _load_dict_format(self, data: dict, competition: str, season: str) -> None:
        ...
        for match_idx in home_data.keys():
            try:
                ...
                self._index_players_from_lineup(match.home_lineup)
                self._index_players_from_lineup(match.away_lineup)
    ...
    def _index_players_from_lineup(self, lineup: dict) -> None:
        ...
        for position, player_data in lineup.items():
            if isinstance(player_data, dict):
                ...
                if name and name not in self._player_index:
                    self._player_index[name] = len(self._player_index)
